...
public class MainActivity extends AppCompatActivity
    ...
    public static final String PREFERENCE_FILE_NAME = "com.collins.personaltasks.preferences";
    public static final String PREF_ACCOUNT_NAME = "accountName";

    public static final String[] SCOPES = { TasksScopes.TASKS, CalendarScopes.CALENDAR_READONLY };
...
;
        ...
        final TaskManager manager = new TaskManager(getApplicationContext());
    ...
    private void chooseAccount() {
        if (EasyPermissions.hasPermissions(
            ...
            String accountName = getSharedPreferences(PREFERENCE_FILE_NAME, Context.MODE_PRIVATE)
